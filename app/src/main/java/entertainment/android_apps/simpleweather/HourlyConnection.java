...
public class HourlyConnection {
    private final static String WEATHER_BASE_URL = "https://dataservice.accuweather.com/forecasts/v1/hourly/12hour/";
...
//    private final static String API_KEY = "5TVlRNdy2MScPsfy6OdLc5a84BKsGAyo";
    ...
    public URL buildUrlForHourlyWeather(String WEATHER_KEY){
    ...
    public String getResponseHourlyWeather(URL url) throws IOException {
